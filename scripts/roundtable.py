...
用法:
    ...
    python3 roundtable.py ad-buyer-senior,consumer-genz-female --question "评价一下抖音购物车体验"
    python3 roundtable.py ad-buyer-senior,consumer-genz-female --output bundle.json
...
from compile_persona import compile_persona  # noqa: E402
